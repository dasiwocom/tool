...
const I18N = {
    ...
    imageConvertDesc: { en: "Convert images between PNG, JPEG, WebP, AVIF and BMP", zh: "在 PNG、JPEG、WebP、AVIF、BMP 之间互转图片" },
    imageSlice: { en: "Image Slice", zh: "图片切割" },
    imageSliceDesc: { en: "Cut one image into a grid of tiles", zh: "将一张图切成多块小图" },
    sliceCols: { en: "Columns", zh: "列数" },
    sliceRows: { en: "Rows", zh: "行数" },
    sliceBtn: { en: "Slice", zh: "切割" },
    imageCrop: { en: "Image Crop", zh: "图片裁剪" },
    imageCropDesc: { en: "Crop a region out of an image", zh: "从图片中裁出一块区域" },
    ...
    textDiffDesc: { en: "Compare two texts line by line", zh: "逐行对比两段文本差异" },
    ...
    loremDesc: { en: "Generate placeholder text for mockups and layouts", zh: "生成用于排版占位的假文内容" },
    ...
    imageFlipDesc: { en: "Mirror or rotate an image", zh: "镜像或旋转图片" },
    ...
    imageResizeDesc: { en: "Change image dimensions while keeping proportions", zh: "按比例调整图片尺寸" },
    ...
    imageCircleCropDesc: { en: "Crop an image into a circle with transparent background", zh: "把图片裁剪成圆形，背景透明" },
    ...
    imageStitchDesc: { en: "Merge several images into one, side by side or stacked", zh: "把多张图片拼成一张" },
    ...
    gifMakerDesc: { en: "Combine images into an animated GIF", zh: "把多张图片合成动态 GIF" },
    ...
    qrcodeDesc: { en: "Generate a scannable QR code", zh: "生成可扫描的二维码" },
